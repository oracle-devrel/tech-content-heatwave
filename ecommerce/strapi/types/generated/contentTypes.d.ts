...
export interface ApiLanguageLanguage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    language_name: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    reviews: Attribute.Relation<
      ...
      'api::review.review'
    >;
    productdetails: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::productdetail.productdetail'
    >;
    productdescriptions: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::productdescription.productdescription'
    >;
    orderitems: Attribute.Relation<
      'api::product.product',
      'oneToMany',
...
export interface ApiProductdescriptionProductdescription
  extends Schema.CollectionType {
  collectionName: 'productdescriptions';
  info: {
    singularName: 'productdescription';
    pluralName: 'productdescriptions';
...
export interface ApiProductdetailProductdetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    washing_instructions: Attribute.String;
    product: Attribute.Relation<
      'api::productdetail.productdetail',
      'manyToOne',
      'api::product.product'
...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    language_code: Attribute.Enumeration<['en', 'es', 'it', 'de']>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::productdescription.productdescription': ApiProductdescriptionProductdescription;
